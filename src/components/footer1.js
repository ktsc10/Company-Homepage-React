        ...
        <div className="footer1-content">
          <div className="footer1-newsletter">
            ...
            <span className="thq-body-small">
              <span>{/*locale-content1_peIWNv*/}</span>
            </span>
            ...
            <div className="footer1-column2">
              ...
              <div className="footer1-footer-links2">
                ...
                >
                  {props.link7 ?? (
                    <Fragment>
                      <span className="footer1-text12">
                        <span>{/*locale-text_HSzj9o*/}</span>
                      </span>
                    </Fragment>
                  )}
                </a>
                ...
                >
                  {props.link10 ?? (
                    <Fragment>
                      <span className="footer1-text14">
                        <span>{/*locale-text_Z1uqJ_*/}</span>
                      </span>
                    </Fragment>
                  )}
                </a>
            ...
            <div className="footer1-column3">
              ...
              <div className="footer1-social-links">
                <div className="footer1-link14">
                  ...
                  <span className="thq-body-small">
                    <span>{/*locale-socialLink1_SZJUpl*/}</span>
                  </span>
                </div>
                <div className="footer1-link15">
                  ...
                  <span className="thq-body-small">
                    <span>{/*locale-socialLink2_0ntuBZ*/}</span>
                  </span>
                </div>
                <div className="footer1-link16">
                  ...
                  <span className="thq-body-small">
                    <span>{/*locale-socialLink3_QVWhtn*/}</span>
                  </span>
                </div>
                <div className="footer1-link17">
                  ...
                  <span className="thq-body-small">
                    <span>{/*locale-socialLink4_IPclN4*/}</span>
                  </span>
                </div>
                <div className="footer1-link18">
                  ...
                  <span className="thq-body-small">
                    <span>{/*locale-socialLink5_BUGrW_*/}</span>
                  </span>
                </div>
              </div>
            </div>
